...
def create_embedding_deployment_and_service(resource_requirements=None):
    ...
    deployment = client.V1Deployment(
        ...
        spec=client.V1DeploymentSpec(replicas=1,
                                     ...
                                     template=client.V1PodTemplateSpec(
                                         metadata=client.V1ObjectMeta(annotations={"sidecar.istio.io/rewriteAppHTTPProbers": "true"},
    ...
    service = create_service(name="embedding-dependency-svc", app_label="embedding-dependency-deploy", service_ports=embedding_dependency_ports)
...
def create_embedding_svc_deployment_and_service(resource_requirements=None):
    ...
    deployment = client.V1Deployment(
        ...
        spec=client.V1DeploymentSpec(
            ...
            template=client.V1PodTemplateSpec(
                metadata=client.V1ObjectMeta(annotations={"sidecar.istio.io/rewriteAppHTTPProbers": "true"}, labels={"app": "embedding-deploy"}),
                spec=client.V1PodSpec(
                    node_selector={"node-type": "chatqna-opea"},
                    ...
                    host_ipc=True,
                    containers=[
                        client.V1Container(name="embedding-deploy",
...
def create_llm_dependency_deployment_and_service(resource_requirements=None):
    ...
    deployment = client.V1Deployment(
        ...
        spec=client.V1DeploymentSpec(replicas=7,
                                         ...
                                         spec=client.V1PodSpec(
                                             ...
                                             containers=[
                                                 client.V1Container(
                                                     ...
                                                     env_from=[client.V1EnvFromSource(config_map_ref=client.V1ConfigMapEnvSource(name="qna-config"))],
                                                     args=[
                                                         "--model-id", "$(LLM_MODEL_ID)", "--max-input-length", "1024", "--max-total-tokens", "2048",
        ...
        spec=client.V1DeploymentSpec(
            ...
            template=client.V1PodTemplateSpec(
                ...
                spec=client.V1PodSpec(
                    ...
                    containers=[
                        client.V1Container(name="reranking-dependency-deploy",
                    ...
                    volumes=[
                        client.V1Volume(name="model-volume", host_path=client.V1HostPathVolumeSource(path="/mnt/models", type="Directory")),
...
def create_llm_deployment_and_service(resource_requirements=None):
    ...
    deployment = client.V1Deployment(
        ...
        spec=client.V1DeploymentSpec(
            ...
            template=client.V1PodTemplateSpec(
                metadata=client.V1ObjectMeta(annotations={"sidecar.istio.io/rewriteAppHTTPProbers": "true"}, labels={"app": "llm-deploy"}),
                spec=client.V1PodSpec(node_selector={"node-type": "chatqna-opea"},
                                      topology_spread_constraints=[
                                          client.V1TopologySpreadConstraint(max_skew=1,
                                                                            topology_key="kubernetes.io/hostname",
                                                                            when_unsatisfiable="ScheduleAnyway",
...
def create_dataprep_deployment_and_service(resource_requirements=None):
    ...
    deployment = client.V1Deployment(
        ...
        spec=client.V1DeploymentSpec(
            ...
            template=client.V1PodTemplateSpec(
                metadata=client.V1ObjectMeta(annotations={"sidecar.istio.io/rewriteAppHTTPProbers": "true"}, labels={"app": "dataprep-deploy"}),
                spec=client.V1PodSpec(
                    node_selector={"node-type": "chatqna-opea"},
                    topology_spread_constraints=[
                        client.V1TopologySpreadConstraint(max_skew=1,
                    ...
                    containers=[
                        client.V1Container(
                            ...
                            env=[
                                ...
                                client.V1EnvVar(name="INDEX_NAME",
                                                value_from=client.V1EnvVarSource(
                                         ...
                                         spec=client.V1PodSpec(
                                             ...
                                             topology_spread_constraints=[
                                                 client.V1TopologySpreadConstraint(
                                                     ...
                                                     topology_key='kubernetes.io/hostname',
                                                     when_unsatisfiable='ScheduleAnyway',
                                                     label_selector=client.V1LabelSelector(match_labels={'app': 'chatqna-backend-server-deploy'}))
                                             ],
                                             host_ipc=True,
                                             containers=[
                                                 client.V1Container(
...
def create_reranking_deployment_and_service(resource_requirements=None):
    ...
    deployment = client.V1Deployment(
        ...
        spec=client.V1DeploymentSpec(
            ...
            template=client.V1PodTemplateSpec(
                metadata=client.V1ObjectMeta(annotations={"sidecar.istio.io/rewriteAppHTTPProbers": "true"}, labels={"app": "reranking-deploy"}),
                spec=client.V1PodSpec(
                    node_selector={"node-type": "chatqna-opea"},
                    topology_spread_constraints=[
                        client.V1TopologySpreadConstraint(max_skew=1,
                    ...
                    host_ipc=True,
                    containers=[
                        client.V1Container(name="reranking-deploy",
...
def create_retriever_deployment_and_service(resource_requirements=None):
    ...
    deployment = client.V1Deployment(
        ...
        spec=client.V1DeploymentSpec(
            ...
            template=client.V1PodTemplateSpec(
                metadata=client.V1ObjectMeta(annotations={"sidecar.istio.io/rewriteAppHTTPProbers": "true"}, labels={"app": "retriever-deploy"}),
                spec=client.V1PodSpec(
                    node_selector={"node-type": "chatqna-opea"},
                    topology_spread_constraints=[
                        client.V1TopologySpreadConstraint(max_skew=1,
                        ...
                        client.V1Container(
                            ...
                            env=[
                                ...
                                client.V1EnvVar(
                                    ...
                                    value_from=client.V1EnvVarSource(
                                        config_map_key_ref=client.V1ConfigMapKeySelector(name="qna-config", key="HUGGINGFACEHUB_API_TOKEN"))),
                                client.V1EnvVar(name="INDEX_NAME",
                                                value_from=client.V1EnvVarSource(
                                                    config_map_key_ref=client.V1ConfigMapKeySelector(name="qna-config", key="INDEX_NAME")))
                            ])
...
def create_vector_db_deployment_and_service(resource_requirements=None):
    ...
    ports = [{'name': 'vector-db-service', 'port': 6379, 'target_port': 6379}, {'name': 'vector-db-insight', 'port': 8001, 'target_port': 8001}]
...
if __name__ == "__main__":
    ...
    # Microservice
    resource_requirements = create_resource_requirements(limits={"cpu": 8, "memory": "4000Mi"}, requests={"cpu": 8, "memory": "4000Mi"})
    ...
    embedding_resources = create_resource_requirements(limits={"cpu": 80, "memory": "20000Mi"}, requests={"cpu": 80, "memory": "20000Mi"})
    ...
    reranking_depn_deployment, reranking_depn_service = create_reranking_dependency_deployment_and_service(reranking_hpu_resource_requirements)
    ...
    manifests = [
        configmap, chatqna_deploy, chatqna_svc, dataprep_deploy, dataprep_svc, embedding_dependency, embedding_dependency_svc, embedding_deploy,
        embedding_deploy_svc, llm_dependency, llm_dependency_svc, lm_deploy, lm_deploy_svc, reranking_depn_deployment, reranking_depn_service,
        reranking_svc, reranking_svc_svc, retrieval_deployment, retrieval_svc, vector_db_deploy, vector_db_svc
    ]
