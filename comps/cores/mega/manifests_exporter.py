...
def create_embedding_deployment_and_service():
...
def create_embedding_svc_deployment_and_service():
...
def create_llm_dependency_deployment_and_service():
...
def create_llm_deployment_and_service():
...
def create_dataprep_deployment_and_service():
...
def create_reranking_deployment_and_service():
...
def create_retriever_deployment_and_service():
...
def create_vector_db_deployment_and_service():
