...
def opea_execute():
    ...
    compose_parser.add_argument('--device', choices=['cpu', 'gaudi', 'xpu', 'gpu'], default='cpu', help='Device type to use (default: cpu)')
    ...
    kube_parser.add_argument('--device', choices=['cpu', 'gaudi', 'xpu', 'gpu'], default='cpu', help='Device type to use (default: cpu)')
