...
class SpecDecodeGateway(Gateway):
    def __init__(self, megaservice, host="0.0.0.0", port=8888):
        super().__init__(
            megaservice, host, port, str(MegaServiceEndpoint.SPEC_DECODE), ChatCompletionRequest, ChatCompletionResponse
        )
        self.drafter_instances: Dict[str, LLM] = {}
    ...
    async def handle_request(self, request: Request):
        ...
        parameters = SpecDecodeParams(
            model=chat_request.model,
            speculative_model=chat_request.speculative_model,
            num_speculative_tokens=chat_request.num_speculative_tokens,
