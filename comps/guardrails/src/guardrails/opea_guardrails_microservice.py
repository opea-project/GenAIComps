...
input_usvc_config = {
    **dotenv_values("utils/.input_env"), 
    **os.environ  
}

output_usvc_config = {
    **dotenv_values("utils/.output_env"), 
    **os.environ  
}
...
async def safety_guard(input: Union[LLMParamsDoc, GeneratedDoc, TextDoc]) -> Union[TextDoc, GeneratedDoc, StreamingResponse]:
