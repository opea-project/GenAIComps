...
class Phi4MMFlashAttention2(Phi4MMAttention):
    """Phi-4-MM flash attention module.

    This module inherits from `Phi4MMAttention` as the weights of the module stays
...
class Phi4MMSdpaAttention(Phi4MMAttention):
    """Phi4MM attention module using torch.nn.functional.scaled_dot_product_attention.
