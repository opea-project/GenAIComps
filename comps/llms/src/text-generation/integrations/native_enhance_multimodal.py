...
MODEL_NAME = os.getenv("LLM_MODEL_ID", "phi-4-multimodel")
    ...
    with initialization_lock:
        if not initialized:
            ...
            if logflag:
                ...
                logger.info("model.config._attn_implementation:", model.config._attn_implementation)
...
@OpeaComponentRegistry.register("OpeaTextGenNativeEnhanceMultimodal")
class OpeaTextGenNativeEnhanceMultimodal(OpeaComponent):
    ...
    def __init__(self, name: str, description: str, config: dict = None):
        ...
        if not health_status:
            logger.error("OpeaTextGenNativeEnhanceMultimodal health check failed.")
        else:
            logger.info("OpeaTextGenNativeEnhanceMultimodal health check success.")
