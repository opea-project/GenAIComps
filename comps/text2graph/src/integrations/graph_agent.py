...
class TripletBuilder():
     def __init__(self):    
         ...
         ## Defines
         self.span_length = int(os.environ['SPAN_LENGTH'])
         self.overlap   = int(os.environ['OVERLAP'])
         self.model     = model
...
##    def print(self):
##        print("All Entities are furnished below:")
##        for entity in self.entities.items():
##            print(f"{entity}")
##        print("All Relations extracted are below:")
##        for relation in self.relations:
##            print(f"{relation}")
