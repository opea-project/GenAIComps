...
async def create_feedback_data(feedback: ChatFeedback):
    ...
    try:
        ...
        if feedback.feedback_id is None:
            response = feedback_store.save_feedback(feedback)
        else:
            response = feedback_store.update_feedback(feedback)
...
async def get_feedback(feedback: FeedbackId):
    ...
    try:
        ...
        if feedback.feedback_id:
            response = feedback_store.get_feedback_by_id(feedback.feedback_id)
        else:
            response = feedback_store.get_all_feedback_of_user()
...
async def delete_feedback(feedback: FeedbackId):
    ...
    try:
        ...
        if feedback.feedback_id is None:
            ...
            response = feedback_store.delete_feedback(feedback.feedback_id)
