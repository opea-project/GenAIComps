...
- Download the dataset from https://mtl.yyliu.net/download/ and extract it to `$DATA/mini-imagenet/`.
- cp -r $DATA/mini-imagenet/val $DATA/mini-imagenet/train && cp -r $DATA/mini-imagenet/test $DATA/mini-imagenet/train
- change the `directory_path` in `./scripts/CLIP_finetune/mini-imagenet.sh`
- run `./scripts/CLIP_finetune/mini-imagenet.sh`
...
```
mini-imagenet/
|–– train/ # contains 100 folders
|–– val/ # contains 100 folders
|–– test/ # contains 100 folders
|–– classnames.txt
```
