...
class ITC_Flickr(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        if os.path.exists(self.preprocessed):
            ...
            train_file = os.path.join(self.dataset_dir, "flickr30k_train.json")
            val_file = os.path.join(self.dataset_dir, "flickr30k_val.json")
            test_file = os.path.join(self.dataset_dir, "flickr30k_test.json")
