...
from dassl.utils import listdir_nohidden, mkdir_if_missing, read_json
...
class ITC_Flickr5k(DatasetBase):

    dataset_dir = "flickr5k"
    ...
    def __init__(self, cfg):
        ...
        if os.path.exists(self.preprocessed):
            ...
            train_file = os.path.join(self.dataset_dir, "flickr5k_train.json")
            val_file = os.path.join(self.dataset_dir, "flickr5k_val.json")
            test_file = os.path.join(self.dataset_dir, "flickr5k_test.json")
        ...
        if num_shots >= 1:
            ...
            if os.path.exists(preprocessed):
                ...
                train = self.generate_fewshot_dataset(train, num_shots=min(num_shots, 4))
