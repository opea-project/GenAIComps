...
class CLIP_Fullfinetune_hf(TrainerX):
    """ CLIP_Fullfinetune """
    ...
    def build_model(self):
        ...
        #clip_model._init_weights(clip_model)
        ...
        self.register_model('clip_fullfinetune_hf', self.model, self.optim, self.sched)
    ...
    def forward_backward(self, batch):
        ...
        if 'ITC' in self.cfg.DATASET.NAME :
            ...
            # if loss > 2:
            #     print("img loss", self.nceloss(logits_img, label))
            #     print("text loss", self.nceloss(logits_text, label))
            #     print("label", label)
            #     print("logits_img", logits_img)
            #     print(logits_img.max(1)[1])
            #     os.exit(1)
        else:
