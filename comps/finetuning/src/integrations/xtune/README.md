...
> [!NOTE]
> - *`Xtune`* provides UI with fine-tuning tool for [CLIP](src/llamafactory/clip_finetune/README.md) and [AdaCLIP](./src/llamafactory/adaclip_finetune/README.md). It makes easier to choose the method and to set fine-tuning parameters.
...
or use the command line to use tools separately which is esier to customize parameters and has more comprehensive functionality.
