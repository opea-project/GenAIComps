...
### 2.1 Start PostGreSQLDB Service
...
curl http://${your_ip}:9090/v1/texttosql\
        -X POST \
        -d '{"input_text": "Find the total number of Albums.","conn_str": {"user": "postgres","password": "testpwd","host": "'${your_ip}'", "port": "5442", "database": "chinook" }}' \
        -H 'Content-Type: application/json'
```