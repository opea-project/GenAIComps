...
class MCPClient:
    def __init__(self):
        ...
        self.client = Client(host=os.environ["OLLAMA_ENDPOINT"] if "OLLAMA_ENDPOINT" in os.environ else "http://localhost:11434",)
    ...
    async def connect_to_server(self, server_script_path: str):
        ...
        server_params = StdioServerParameters(
            ...
            env=get_default_environment() | {"http_proxy": os.environ.get("http_proxy"), "https_proxy": os.environ.get("https_proxy"), "no_proxy": os.environ.get("no_proxy")}
        )
    ...
    async def process_query(self, query: str) -> str:
        ...
        messages.append({'role': 'system', 'content': f'Please use only one tool name relevant to {query} in following: {tool_names}'})
