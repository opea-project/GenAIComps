    ...
    def __init__(
        ...
        if device == "hpu":
            self._warmup_whisper_hpu_graph(
                "https://github.com/opea-project/GenAIComps/blob/main/comps/asr/assets/ljspeech_30s_audio.wav"
            )
            self._warmup_whisper_hpu_graph(
                "https://github.com/opea-project/GenAIComps/blob/main/comps/asr/assets/ljspeech_60s_audio.wav"
            )
