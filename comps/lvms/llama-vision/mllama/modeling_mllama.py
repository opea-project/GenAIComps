...
class ModuleFusedSDPA(torch.nn.Module):
    ...
    def forward(self, query, key, value, attn_mask, dropout_p = 0.0, is_causal = False, scale = False, softmax_mode = "None"):
...
class MllamaVisionSdpaAttention(nn.Module):
    ...
    def forward(
        ...
        # attn_output = self.fused_scaled_dot_product_attention(query, key, value, attn_mask=attention_mask)
