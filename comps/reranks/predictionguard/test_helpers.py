...
class MyTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.simple_case = DocList([
            ...
            TextDoc(text="Another document"),
            TextDoc(text="Third document")
        ])

        self.list_case = DocList([
            TextDoc(text=["First sentence.", "Second sentence."]),
            TextDoc(text=["Another paragraph.", "More text."])
        ])
        ...
        self.none_case = DocList([
            TextDoc(text="Valid text"),
            TextDoc(text=[]),
            TextDoc(text="More text")
        ])
    ...
    def test_mixed_case(self):
        ...
        expected = ["Single string document", "First part",
                    "Second part", "Another single string"]
        self.assertEqual(result, expected)
