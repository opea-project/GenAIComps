...
from comps import LVMVideoDoc, SearchedMultimodalDoc, OpeaComponent, CustomLogger, ServiceType
from comps.cores.mega.utils import get_access_token

logger = CustomLogger("videoqna_reranking")
logflag = os.getenv("LOGFLAG", False)


class VideoqnaReranking(OpeaComponent):
    """
    A specialized reranking component derived from OpeaComponent for VideoQnA reranking services.
