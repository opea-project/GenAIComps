...
import redis
from config import EMBED_MODEL, INDEX_NAME, KEY_INDEX_NAME, REDIS_URL, SEARCH_BATCH_SIZE, ADMIN_ROLE, USER_ROLE
from fastapi import Body, File, Form, HTTPException, UploadFile, Depends
...
async def delete_single_file(file_path: str = Body(..., embed=True), _: Optional[str] = Depends(token_validator([ADMIN_ROLE]))):
