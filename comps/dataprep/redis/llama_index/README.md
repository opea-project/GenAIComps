...
```bash
cd ../../../../
docker build -t opea/dataprep-redis:latest --build-arg https_proxy=$https_proxy --build-arg http_proxy=$http_proxy -f comps/dataprep/llama_index/redis/Dockerfile .
```
...
```bash
cd comps/dataprep/llama_index/redis
