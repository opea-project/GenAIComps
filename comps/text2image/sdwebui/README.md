...
```bash
python text2image_sdwebui.py --bf16 --model_name_or_path $MODEL --token $HF_TOKEN
```
...
### 2.1.1 Text-to-Image Service Image on Gaudi
...
### 2.2.1 Start Text-to-Image Service on Gaudi
