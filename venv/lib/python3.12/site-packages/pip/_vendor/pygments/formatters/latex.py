...
class LatexFormatter(Formatter):
        ...
        for ttype, ndef in self.style:
            ...
            if ndef["border"]:
                cmndef += (
                    ...
                    r"\fcolorbox[rgb]{%s}{%s}{\strut ##1}}}" % (rgbcolor(ndef["border"]), rgbcolor(ndef["bgcolor"]))
                )
            elif ndef["bgcolor"]:
                cmndef += r"\def\$$@bc##1{{\setlength{\fboxsep}{0pt}" r"\colorbox[rgb]{%s}{\strut ##1}}}" % rgbcolor(
                    ndef["bgcolor"]
                )
            if cmndef == "":
                continue
    ...
    def get_style_defs(self, arg=""):
        ...
        used to format text in the verbatim environment.
