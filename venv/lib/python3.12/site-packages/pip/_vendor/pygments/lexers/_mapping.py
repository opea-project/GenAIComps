...
LEXERS = {
    ...
    "AlloyLexer": ("pip._vendor.pygments.lexers.dsls", "Alloy", ("alloy",), ("*.also",), ("text/x-alloy",)),
    "AmbientTalkLexer": (
    ...
    "HsailLexer": ("pip._vendor.pygments.lexers.asm", "HSAIL", ("hsail", "has"), ("*.hsail",), ("text/x-hsail",)),
    ...
    "WatLexer": ("pip._vendor.pygments.lexers.webassembly", "WebAssembly", ("waste", "wat"), ("*.wat", "*.waste"), ()),
