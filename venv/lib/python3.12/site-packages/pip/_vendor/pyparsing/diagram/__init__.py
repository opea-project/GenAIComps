...
class EditablePartial(Generic[T]):
    ...
    In other words, it represents a type that hasn't yet been
    constructed.
    """
    ...
    def from_call(cls, func: Callable[..., T], *args, **kwargs) -> "EditablePartial[T]":
        ...
        For example EditablePartial.from_call(Fraction, 1, 3)() == Fraction(1, 3)
        """
...
class ElementState:
    ...
    def mark_for_extraction(self, el_id: int, state: "ConverterState", name: str = None, force: bool = False):
        ...
        :param force: If true, force extraction now, regardless of the state of this.

        Only useful for extracting the
...
class ConverterState:
    ...
    def extract_into_diagram(self, el_id: int):
        """Used when we encounter the same token twice in the same tree.
...
def _worth_extracting(element: pyparsing.ParserElement) -> bool:
    """Returns true if this element is worth having its own sub-diagram.

    Simply, if any of its children
...
def _to_diagram_element(
    ...
    :param vertical: Controls at what point we make a list of elements vertical.

    If this is an integer (the default),
