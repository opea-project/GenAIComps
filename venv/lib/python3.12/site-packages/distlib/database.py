...
class _Cache(object):
    ...
    def __init__(self):
        ...
        There is normally one for each DistributionPath.
        """
        self.name = {}
        self.path = {}
...
class InstalledDistribution(BaseInstalledDistribution):
    ...
    It reads the metadata contained in ``pydist.json`` when it is
    ...
    def _get_records(self):
        ...
        :return: A list of tuples of path, hash and size.
    ...
    def check_installed_files(self):
        ...
        matched by the files themselves.
...
class EggInfoDistribution(BaseInstalledDistribution):
    ...
    It reads the metadata contained in the file itself, or
