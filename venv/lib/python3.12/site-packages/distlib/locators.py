...
class SimpleScrapingLocator(Locator):
    ...
    def _prepare_threads(self):
        ...
        They are there primarily to parallelise I/O (i.e.
        fetching web pages).
        """
        self._threads = []
...
class DirectoryLocator(Locator):
    ...
    def should_include(self, filename, parent):
        ...
        As well as the filename, the directory which contains it
...
class JSONLocator(Locator):
    ...
    the basis of performant dependency resolution in distlib.
...
class DependencyFinder(object):
    ...
    def add_distribution(self, dist):
        ...
        This will update internal information
