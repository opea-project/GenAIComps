...
function start_service() {
    ...
    docker run -d --name="test-comps-asr" -e ASR_ENDPOINT=http://$ip_address:7066 -e http_proxy=$http_proxy -e https_proxy=$https_proxy -p 9089:9089 --ipc=host opea/asr:comps
    sleep 3m
}
