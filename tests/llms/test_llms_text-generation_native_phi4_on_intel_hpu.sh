...
service_name="textgen-native-phi4-gaudi"
...
function start_service() {
    ...
    export LLM_MODEL_ID="microsoft/Phi-4-mini-instruct"
    export LOGFLAG=True
...
function validate_microservices() {
    ...
    validate_services \
        ...
        "$service_name" \
        "$service_name" \
        '{"model": "microsoft/Phi-4-mini-instruct", "messages": "What is Deep Learning?", "max_tokens":17, "stream":false}'
}
