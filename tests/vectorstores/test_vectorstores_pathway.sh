...
function build_docker_images() {
    ...
    docker build --build-arg https_proxy=$https_proxy --build-arg http_proxy=$http_proxy -t opea/vectorstore-pathway:comps -f comps/vectorstores/src/pathway/Dockerfile .
