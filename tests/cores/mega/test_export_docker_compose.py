...
class TestConvertToDockerCompose(unittest.TestCase):
    ...
    def test_convert_to_docker_compose_gaudi(self):
        ...
        self.assertEqual(docker_compose['services']['text-embeddings-inference-service']['image'],
                         'opea/tei-gaudi:latest')
        self.assertEqual(docker_compose['services']['text-embeddings-inference-service']['runtime'],
                         'habana')
    ...
    def test_convert_to_docker_compose_cli(self):
        ...
        command = [
            'opea', 'export', 'docker-compose',
            self.mega_yaml, self.output_file, '--device=cpu'
        ]
