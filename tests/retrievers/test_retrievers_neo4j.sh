...
function start_service() {
    ...
    docker run -d --name="test-comps-retrievers-neo4j-llama-index-server" -p 6009:7000 --ipc=host -e TGI_LLM_ENDPOINT=$TGI_LLM_ENDPOINT -e TEI_EMBEDDING_ENDPOINT=$TEI_EMBEDDING_ENDPOINT \
        ...
        -e NEO4J_URI="bolt://${ip_address}:7687" -e NEO4J_USERNAME="neo4j" -e NEO4J_PASSWORD="neo4jtest" -e VDMS_USE_CLIP=0 -e LOGFLAG=True \
        -e RETRIEVER_COMPONENT_NAME="OPEA_RETRIEVER_NEO4J" opea/retriever-neo4j-llamaindex:comps
